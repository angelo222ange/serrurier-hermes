...
const region = regionConfigs.montpellier;

// Meta Title optimisé < 60 caractères | Meta Description < 155 caractères
export const metadata: Metadata = {
  title: `Tarifs Serrurier Montpellier - Dès 69€ | Hermès`,
  description: `Tarifs serrurier Montpellier : ouverture porte dès 69€, changement serrure dès 89€. Prix transparents, devis gratuit. ☎️ ${region.phone}`,
};

export default function TarifsMontpellierPage() {
  return (
    <main className="pt-20">
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 via-white to-gray-50">
        <div className="container text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Tarifs Serrurier Montpellier
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Des prix clairs et transparents pour Montpellier et l'Hérault. Devis gratuit communiqué avant toute intervention.
      ...
      {/* Tarifs */}
      <Tarifs 
        title="Nos tarifs indicatifs à Montpellier"
      ...
      {/* FAQ tarifs */}
      <FAQ 
        title="Questions sur nos tarifs à Montpellier"
      />
