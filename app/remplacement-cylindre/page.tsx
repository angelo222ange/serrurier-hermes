...
import serviceContent from "@/content/pages/services/remplacement-cylindre.json";

const SERVICE_SLUG = "remplacement-cylindre";
...
export default function RemplacementCylindrePage() {
