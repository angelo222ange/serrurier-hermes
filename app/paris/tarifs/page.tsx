...
const region = regionConfigs.paris;

// Meta Title optimisé < 60 caractères | Meta Description < 155 caractères
export const metadata: Metadata = {
  title: `Tarifs Serrurier Paris - Dès 69€ | Hermès`,
  description: `Tarifs serrurier Paris : ouverture porte dès 69€, changement serrure dès 89€. Prix transparents, devis gratuit. ☎️ ${region.phone}`,
};

export default function TarifsParisPage() {
  return (
    <main className="pt-20">
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 via-white to-gray-50">
        <div className="container text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Tarifs Serrurier Paris
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Des prix clairs et transparents pour Paris et l'Île-de-France. Devis gratuit communiqué avant toute intervention.
      ...
      {/* Tarifs */}
      <Tarifs 
        title="Nos tarifs indicatifs à Paris"
      ...
      {/* FAQ tarifs */}
      <FAQ 
        title="Questions sur nos tarifs à Paris"
      />
