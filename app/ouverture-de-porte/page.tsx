...
import serviceContent from "@/content/pages/services/ouverture-de-porte.json";

const SERVICE_SLUG = "ouverture-de-porte";
const service = getServiceBySlug(SERVICE_SLUG)!;

// Remplacer les variables dans le contenu (sans ville)
...
export default function OuverturePortePage() {
  ...
  return (
    <main className="pt-20">
      ...
      <CTA title={content.cta?.title || `Besoin d'une ${service.name.toLowerCase()} ?`} subtitle={content.cta?.subtitle} variant="dark" />
    </main>
  );
}
