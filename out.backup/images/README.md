...
| Fichier | Dimensions | Utilisation |
|---------|------------|-------------|
| `paris-1.webp` | 800×600 | Page zone Paris 1er |
| `paris-2.webp` | 800×600 | Page zone Paris 2ème |
| `bordeaux.webp` | 800×600 | Page zone Bordeaux |
| `montpellier.webp` | 800×600 | Page zone Montpellier |
| ... | | |
